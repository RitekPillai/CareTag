    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          {/* 🔧 TEMP: Mock patient preview button - remove after backend is ready */}
          <Button
            variant="outline"
            className="gap-2 border-dashed border-yellow-400 text-yellow-600 hover:bg-yellow-50"
            onClick={() => navigate('/patients/mock-001')}
          >
            🧪 Preview Mock Patient
          </Button>
          <Button 
            className="gap-2" 
